...
<TextBlock Style="{StaticResource TitleBlock}" Text="本周页面--%(topic)s" />
...
" />
    ...
    <local:MyIconTextButton HorizontalAlignment="Left" Text="GitHub" ToolTip="前往Wiki 摘录主页 GitHub 页面" EventType="打开网页"
    EventData="https://github.com/Ext1nguisher/PCLhomepage"
